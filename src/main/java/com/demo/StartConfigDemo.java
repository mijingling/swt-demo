...
public class StartConfigDemo {
	...
	public static void main(String[] args) {
		...
		addItem.setImage(new Image(toolBar.getDisplay(), "icons//add.png"));
		final ToolItem deleteItem = new ToolItem(toolBar, SWT.PUSH);
		deleteItem.setImage(new Image(toolBar.getDisplay(), "icons//delete.png"));
		final ToolItem upItem = new ToolItem(toolBar, SWT.PUSH);
		upItem.setImage(new Image(toolBar.getDisplay(), "icons//up.png"));
		final ToolItem downItem = new ToolItem(toolBar, SWT.PUSH);
		downItem.setImage(new Image(toolBar.getDisplay(), "icons//down.png"));
...
class TableItemControls {
	...
	public TableItemControls(Text name, Text type, Text value, TableEditor tableeditor, TableEditor tableeditor1,
			TableEditor tableeditor2) {
		// super();
		this.name = name;
		this.type = type;
